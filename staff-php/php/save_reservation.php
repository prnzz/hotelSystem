...
$saveReservation = mysqli_query($dbconn, "INSERT INTO reservations (customer_id, unit_id, check_in_date, expected_check_out, duration_days, total_bill, status) VALUES ('$customer_id', '$unit_id', '$check_in', '$check_out', '$duration', '$total', 'Pending')");
