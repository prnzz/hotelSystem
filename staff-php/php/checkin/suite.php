<div class="content-holder">
    ...
    <body>
        <div class="table-wrapper">
            <div class="table-header">ACTIVE CHECK-INS: SUITE ROOMS</div>
                ...
                <table class="reservationTable">
                    ...
                    <tbody>
                        ...
                        $db = mysqli_connect($host, $username, $password, $database);
                         $customerList = mysqli_query($db, "SELECT * FROM `check_in_out_master` WHERE unit_type = 'Suite' AND status = 'Checked-In'");
                        $counter = 0;
