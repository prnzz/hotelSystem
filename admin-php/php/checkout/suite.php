<div class="content-holder">
    ...
    <body>
        <div class="table-wrapper">
            <div class="table-header">ACTIVE CHECK-OUTS: SUITE ROOMS</div>
            <div class="table-scroll">
                <table class="reservationTable">
                    ...
                    <tbody>
                        ...
                        $customerList = mysqli_query($db, "SELECT * FROM `check_in_out_master` WHERE unit_type = 'Suite' AND status = 'Checked-Out'");
                        $counter = 0;
