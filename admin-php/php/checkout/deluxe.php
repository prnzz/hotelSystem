<div class="content-holder">
    ...
    <div class="table-wrapper">
        <div class="table-header">ACTIVE CHECK-OUTS: DELUXE ROOMS</div>
        <div class="table-scroll">
            <table class="reservationTable">
                ...
                <tbody>
                    ...
                    $customerList = mysqli_query($db, "SELECT * FROM `check_in_out_master` WHERE unit_type = 'Deluxe' AND status = 'Checked-Out'");
                    $counter = 0;
