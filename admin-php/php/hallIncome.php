        ...
        <div class="table-wrapper">
            ...
            <div class="table-scroll">
                ...
                <tbody>
                    ...
                    $customerList = mysqli_query($db, "SELECT * FROM `current_reservation_in_customer` WHERE unit_type_name = 'Function Hall' AND payment_status = 'Paid' AND status != 'Cancelled'");
                    $counter = 0;
